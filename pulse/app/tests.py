...
class SimpleTest(TestCase):
    ...
    def test_es_popular(self):
        ...
        enlace = Enlace.objects.create(titulo='Enlace de prueba', enlace='http://www.google.com', votos=0, categoria=self.categoria, usuario=self.usuario)
    ...
    def test_views(self):
        ...
        self.assertTrue(self.client.login(username='pepe', password='barbas'))
